...
# 后台IP设置
export Ipv4_ipaddr="172.16.3.16"            # 修改openwrt后台地址(填0为关闭)
export Netmask_netm="255.255.248.0"         # IPv4 子网掩码（默认：255.255.255.0）(填0为不作修改)
export Op_name="Wy.House"                # 修改主机名称为OpenWrt-123(填0为不作修改)
...
export Customized_Information="Wy $(TZ=UTC-8 date "+%Y.%m.%d")"  # 个性签名,你想写啥就写啥，(填0为不作修改)
